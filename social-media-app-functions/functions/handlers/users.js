...
exports.signup =  (req,res) => {
    ...
    .then(doc => {
        if(doc.exists){
            return res.status(400).json({ handle: 'this handle is aleready taken'});
        }
        else{
            return firebase
                .auth()
...
exports.uploadImage = (req,res) => {
    const BusBoy = require('busboy'); // Busboy is a node.js module for parsing incoming HTML form data.
    ...
    busboy.on('file', (fieldname, file, filename, encoding, mimetype) => {
        ...
        // eg. if filename is my.image.png we need to get .png
